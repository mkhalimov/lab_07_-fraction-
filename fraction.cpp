...
const fraction operator+(const fraction& left, const fraction& right)
{
    ...
    unsigned long left_coefficient = lcm/left.denominator, right_coef = lcm/right.denominator;
    
	left_clone = fraction(left_clone.numenator*left_coefficient, left_clone.denominator*left_coefficient);
    right_clone = fraction(right_clone.numenator*right_coef, right_clone.denominator*right_coef);
